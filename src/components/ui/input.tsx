  ...
  return (
    <input
      ...
      className={cn(
        ...
        // Dark mode FIX: Explicit text color with !important-level specificity
        "dark:!text-slate-100 dark:bg-input/30 dark:placeholder:!text-slate-500 dark:!caret-slate-100 dark:selection:bg-teal-500/30 dark:selection:!text-slate-100",
